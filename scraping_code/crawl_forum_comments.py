...
def get_all_comments_for_forum_id(forum_id, path):
    '''
    This function scrapes all the comments
    of a particular forum and saves in a json file.
    Parameters
    ----------
    forum_id : str
        The id of the forum to be scraped for comments
    path : str
        path where the json file containing
        all comments for the particular forum id will be stored.
    Returns
    -------
    None
    '''
    ...
    def get_children(root, json_data):
        '''
        This function takes json_data from api requests and creates an
        adjacency list representation of forum comments.
        Parameters
        ----------
    ...
    def populate_json(root, json_data, comments):
        '''
        This function takes json_data from api requests and uses adjacency
        list representation of forum comments.
